...
export type LbClmm = {
  ...
  instructions: [
    ...
    {
      name: "createCrossedBinLimitOrder";
      discriminator: [80, 129, 118, 36, 208, 176, 50, 139];
      accounts: [
        {
          name: "lbPair";
          relations: ["binArray"];
        ...
        {
          name: "binArray";
          docs: ["bin array that includes bin id"];
          writable: true;
        },
        {
          name: "payer";
          docs: ["permissionless, anyone could do this"];
          writable: true;
          signer: true;
        },
        {
      ...
      accounts: [
        {
          name: "lbPair";
          writable: true;
          relations: ["binArrayBitmapExtension", "binArray"];
        },
        {
          name: "binArrayBitmapExtension";
          writable: true;
        ...
        {
          name: "binArray";
          docs: ["bin array that includes bin id user want to add limit order"];
          writable: true;
        },
        {
          name: "tokenMint";
      ...
      args: [
        {
          ...
          type: {
            defined: {
              name: "placeLimitOrderParameters";
            };
          };
        }
      ];
    ...
    },
    {
      ...
      discriminator: [53, 165, 27, 0, 79, 126, 79, 37];
      accounts: [
        {
          name: "lbPair";
          writable: true;
          relations: ["binArrayBitmapExtension", "limitOrder", "binArray"];
        },
        {
          name: "binArrayBitmapExtension";
          writable: true;
  ...
  accounts: [
    ...
    {
      name: "crossedBinLimitOrder";
      discriminator: [245, 54, 39, 88, 58, 26, 231, 68];
    },
    {
      name: "dummyZcAccount";
  ...
  events: [
    ...
    {
      name: "createCrossedBinLimitOrderEvt";
      discriminator: [1, 176, 59, 226, 169, 225, 117, 18];
    },
    {
      name: "decreasePositionLength";
    ...
    {
      name: "removeLimitOrderEvt";
      discriminator: [201, 48, 25, 211, 138, 193, 131, 206];
    },
    {
      name: "removeLiquidity";
  ...
  errors: [
    ...
    {
      code: 6104;
      name: "invalidLimitOrderParameters";
      msg: "Invalid limit order parameters";
    },
    {
      code: 6105;
      name: "invalidCrossedBinLimitOrder";
      msg: "Invalid crossed bin limit order";
    }
  ];
  types: [
    {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "cummulativeSwappedAmountPerLoLiquidity";
            docs: [
              "****** START OF SECTION WHERE THE FIELDS ARE VARIES BASED ON FUNCTION TYPE ******",
              "LiquidityMining:",
              "reward_per_token_stored index 0: cummulative_swapped_amount_per_liquidity[0..16]",
              "reward_per_token_stored index 1: cummulative_swapped_amount_per_liquidity[16..]",
              "LimitOrder:",
              "sum(swapped_amount << 128 / liquidity)"
            ];
            type: {
              array: ["u8", 32];
            };
          ...
          {
            name: "limitOrderLiquidity";
            docs: ["liquidity liquidity"];
            type: "u128";
          },
          {
            name: "biddedAmount";
            docs: ["Only has value in limit order"];
            type: "u64";
          },
          {
            name: "limitOrderIndex";
            docs: [
              "Limit order index, only has value in limit order",
              "Note: In case index is overflow later, we could use padding right bellow to upscale the value"
            ];
            type: "u32";
          },
          {
          ...
          },
          {
            ...
            docs: [
              "Limit order flag",
              "first bit: 0 = bid side, 1 = ask side",
              "second bit: 0 = not crossed, 1 = has been crossed"
            ];
            type: "u8";
          }
        ];
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "snapshotCummulativeSwappedAmountPerLoLiquidity";
            type: {
              array: ["u8", 32];
            };
          },
          {
            name: "biddedAmount";
            docs: ["order amount user created"];
            type: "u64";
          },
          {
            name: "limitOrderIndex";
            docs: ["limit order index"];
            type: "u32";
          },
          {
            name: "binId";
            docs: ["bin id user create order at"];
            type: "i32";
          },
          {
            name: "isAsk";
            docs: ["ask side or bid side"];
            type: "u8";
          },
          {
            name: "padding0";
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "transferFeeIncludedAmount";
            type: "u64";
          },
          {
            name: "params";
    ...
    {
      name: "swap2Evt";
      docs: ["From now on, we will always use Evt as post-fix", ""];
      type: {
        kind: "struct";
        fields: [
          {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "lpLimitOrderFee";
            type: "u64";
          },
          {
            name: "limitOrderFilledAmount";
            type: "u64";
          },
          {
            name: "limitOrderSwappedAmount";
            type: "u64";
          }
        ];
      };
  ...
  constants: [
    ...
    {
      name: "crossedBinLimitOrderPrefix";
      type: "bytes";
      value: "[99, 114, 111, 115, 115, 101, 100, 95, 98, 105, 110, 95, 108, 105, 109, 105, 116, 95, 111, 114, 100, 101, 114]";
    },
    {
    ...
    {
      name: "protocolLimitOrderFeeBps";
      docs: ["Limit order fee, 0%, we could enable in the future"];
      type: "u16";
      value: "10000";
    },
    {
